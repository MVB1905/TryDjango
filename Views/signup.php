					...
					<div class="login-wrap p-0">
							<div class="form-group" align="center">
								...
								<?php
									...
									{
										echo "Email đã tồn tại tài khoản vui lòng thử lại";
										$_SESSION['errorCreate'] = null;
									} 
								?>
								</label>
							</div>
						<form action="../../QLDTKH/Controllers/Home/C_home.php?action=signup_submit" class="signin-form" method="post">

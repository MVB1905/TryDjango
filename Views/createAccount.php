<?php
	...
	if (isset($_POST['pass']))
	{
		...
		if (getCheck($sql) <= 0)
		{
			...
			{
				InsertAccount($_POST['name'], $_POST['username'], $_POST['pass'], 'USER', $_SESSION['forgotEmail']);
				session_destroy();
				...
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
							<div class="form-group" align="center">
								...
								<label class="text-danger"><?php if (isset($_POST['pass'])){ $username = $_POST['username']; $sql = "SELECT * FROM account WHERE username = '$username'"; if (getCheck($sql) > 0){ echo "Tên đăng nhập đã tồn tại vui lòng thử lại!";}}?></label>
							</div>
						<form action="createAccount.php" class="signin-form" method="post">
